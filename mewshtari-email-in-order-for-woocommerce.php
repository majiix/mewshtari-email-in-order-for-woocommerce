...
add_action( 'before_woocommerce_init', 'mewshtari_email_in_order_declare_compatibility' );

function mewshtari_email_in_order_declare_compatibility(): void {
...
function mewshtari_email_in_order_init(): void {
