...
3. Configure your templates under 'WooCommerce' -> 'Email in Orders'.

== FAQ ==

= How do I use shortcodes? =
Simply insert [name], [product_title], [product_link], or [order_date] inside your HTML template. They will be replaced dynamically before sending.
